...
public class DrawingAcitity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		System.out.println("in drawing activity");
		...
		toastShow = new ToastShow(DrawingAcitity.this);
...
//	 }
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		menu.add(0,ITEM5,0,getResources().getString(R.string.menu_exit)).setIcon(R.drawable.exit);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		//history
			...
			Intent intent = new Intent(DrawingAcitity.this, HistoryAcitvity.class);
		...
		//setting
			...
			Intent intent = new Intent(DrawingAcitity.this,MenuPreferenceActivity.class);
			startActivityForResult(intent,1);
        }
		//help
		else if(item.getItemId() == ITEM3){
			Intent intent = new Intent(DrawingAcitity.this, HelpActivity.class);
			startActivity(intent);
        }
		//about
		else if(item.getItemId() == ITEM4){
			Intent intent = new Intent(DrawingAcitity.this, AboutActivity.class);
			startActivity(intent);
        }
		//exit
